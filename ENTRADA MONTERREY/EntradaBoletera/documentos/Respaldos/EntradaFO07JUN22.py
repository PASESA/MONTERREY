...
# -----------------------------------
    def ExpedirRfid(self):    
        ...
        #self.entryNumTarjeta.bind('Return', self.Pensionados)
    ...
    def check_inputs(self):
        ...
        self.ventana1.after(100, self.check_inputs)          # activa un timer de 50mSeg.
...
#        masuno = int(n1)+int(n2)
        ...
        p.text('Entrada (Monterrey)'+placa+'\n')
        p.set(align="left")
        #p.image("LOGO1.jpg")
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$impresion fin$$$$$$$$$$$$$$$$        
        ...
        self.Placa.set('')
######PENSIONADOS
    def Pensionados(self):
        #mb.showwarning("IMPORTANTE", "Entro a Pensionados")
