...
class FormularioOperacion:
    def __init__(self):
        ...
        self.ventana1=tk.Tk()
        self.ventana1.title("BOLETERA DE SALIDA")
...
# -----------------------------------
    def ExpedirRfid(self):    
        ...
        self.cuaderno1.add(self.pagina1, text="Dar Salida")
        #enmarca los controles LabelFrame
        self.labelframe1=ttk.LabelFrame(self.pagina1, text="Dar Entrada Y VERIFICA SALIDA")
        ...
        self.presenciaAuto = ttk.Label(self.labelframe1, text="TIPO DE SALIDA", width = 17)#, background = '#CCC')
        ...
        self.boton1=tk.Button(self.labelframe1, text="Generar Entrada", command=self.agregarRegistroRFID, width=10, height=1, anchor="center", background="yellow")
    ...
    def check_inputs(self):
                ...
                if io.input(loop):
                        ...
                        if id:
                                print(id)
                                self.loopDet.config(text = "Salio pensionado")
...
#########################fin de pagina1 inicio pagina2#########################
    def consulta_por_folio(self):
        ...
        self.cuaderno1.add(self.pagina2, text=" Salida")
        #en el frame
    ...
    def consultar(self,event):
        ...
        largo = len(datos)
        print (largo)
        if len(datos) > 20 and len(datos) < 37:#con esto revisamos si lee el folio o la promocion
            datos=datos[26:]
            datos=int(datos)
            datos=str(datos)
            self.folio.set(datos)
        ...
        if len(datos) == 38:
            ...
            self.label15.configure(text=("se leyo boleto de salida"))
