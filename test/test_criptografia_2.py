...
def test():
    folio = input("Ingresa el folio a codificar: ")

    folio_cifrado = cifrar_folio(folio = folio)
    ...
    folio_descifrado = descifrar_folio(folio_cifrado = qr)

    print(f"\nFolio desifrado: {folio_descifrado}")

    # if folio == folio_descifrado: print("\nDESIFRADO CORRECTO")
    # else: print("\nCifrado incorrecto")
