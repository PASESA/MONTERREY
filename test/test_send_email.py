...
class ToolsEmail:
    def check_internet_connection(self, url: str = "http://www.google.com", timeout: int = 5) -> bool:
        ...
        try:
            ...
            response.raise_for_status()  # Lanza una excepción si la respuesta HTTP no es exitosa
...
# Configuración para el servidor SMTP del dominio de la empresa
smtp_server = "smtp.pasesa.com.mx"
# Configurar el puerto 1025 según documentación de Telmex
smtp_port = 1025
# Dirección de correo
...
estacionamiento="Monterrey"

# Crear el mensaje con archivo adjunto
to_email = 'brinknene@gmail.com'
subject = 'Envio de DB'
message="Base de datos 08/08/2023"
file_path = 'C:/Users/brink/Music/#Z/WORKSPACE/MONTERREY/Parqueadero1.sql'

email = SendEmail(username = username,
                password=password,
                estacionamiento=estacionamiento)

email.send_mail(to_email=to_email,
                subject=subject,
                message=f"Base de datos de {estacionamiento} 08/08/2023",
                file=file_path)
