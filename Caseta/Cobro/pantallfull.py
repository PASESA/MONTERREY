...
class Login_sistema:
    def __init__(self):
        ...
        self.entryNombre = tk.Entry(
            self.labelframe1, width=10, textvariable=self.Nombre)  # , state="readonly")
        self.entryNombre.grid(column=1, row=0, padx=4, pady=4)
        self.entryNombre.focus()
        self.Contraseña = tk.StringVar()
        self.entryContraseña = tk.Entry(
            self.labelframe1, width=10, textvariable=self.Contraseña, show="*", justify=tk.RIGHT)
        self.entryContraseña.grid(column=1, row=1, padx=4, pady=4)
        self.Turno = tk.StringVar()
        # , state="readonly")
        self.entryTurno = tk.Entry(
            self.labelframe1, width=10, textvariable=self.Turno)
        ...
        self.lblHorario1 = tk.Label(
            self.labelframe1, text="1 ero de 7am a 3 pm.")
        self.lblHorario1.grid(column=2, row=0, padx=0, pady=0)
        self.lblHorario2 = tk.Label(
            self.labelframe1, text="2 o de 3pm a 10 pm.")
        self.lblHorario2.grid(column=2, row=1, padx=0, pady=0)
        self.lblHorario3 = tk.Label(
            self.labelframe1, text="3 ero de 10pm a 7 am.")
        ...
        self.boton1 = tk.Button(self.labelframe1, text="Salir ", command=self.quitF,
                                width=10, height=1, anchor="center", background="red")
        self.boton1.grid(column=2, row=3, padx=4, pady=4)
        self.boton2 = tk.Button(self.labelframe1, text="Entrar", command=self.abrirPrograma,
                                width=10, height=1, anchor="center", background="green")
    ...
    def abrirPrograma(self):
        ...
        if contrasena != password_usuario:
            mb.showwarning(
                "IMPORTANTE", "La Contraseña no coincide, volver a capturarla")
