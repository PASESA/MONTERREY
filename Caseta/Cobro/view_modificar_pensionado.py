...
class View_modificar_pensionados():
    ...
    def interface(self):
        ...
        seccion_datos_pensionado = ttk.LabelFrame(
            seccion_superior, text="\t\t\tIngresa los datos del pensionado a modificar")
        seccion_datos_pensionado.grid(
            row=1, column=0, padx=5, pady=5, sticky=tk.NW)

        seccion_datos_personales_pensionado = tk.LabelFrame(
            seccion_datos_pensionado, text="Datos personales del pensionado")
        seccion_datos_personales_pensionado.grid(
            row=2, column=0, padx=5, pady=5, sticky=tk.NW)

        etiqueta_numero_tarjeta = ttk.Label(
            seccion_datos_personales_pensionado, text='Número de tarjeta: ')
        etiqueta_numero_tarjeta.grid(
            row=0, column=0, padx=5, pady=5, sticky=tk.NW)
        self.campo_numero_tarjeta = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_numero_tarjeta, state="disabled")
        self.campo_numero_tarjeta.grid(row=0, column=1, padx=5, pady=5)

        etiqueta_nombre_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Nombre: ')
        etiqueta_nombre_pensionado.grid(
            row=1, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_nombre_pensinado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_nombre)
        campo_nombre_pensinado.grid(row=1, column=1, padx=5, pady=5)

        etiqueta_apellido_1_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Primer apellido: ')
        etiqueta_apellido_1_pensionado.grid(
            row=2, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_apellido_1_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_apellido_1)
        campo_apellido_1_pensionado.grid(row=2, column=1, padx=5, pady=5)

        etiqueta_apellido_2_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Segundo apellido: ')
        etiqueta_apellido_2_pensionado.grid(
            row=3, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_apellido_2_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_apellido_2)
        campo_apellido_2_pensionado.grid(row=3, column=1, padx=5, pady=5)

        etiqueta_telefono_1_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Telefono 1: ')
        etiqueta_telefono_1_pensionado.grid(
            row=4, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_telefono_1_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_telefono_1)
        campo_telefono_1_pensionado.grid(row=4, column=1, padx=5, pady=5)

        etiqueta_telefono_2_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Telefono 2: ')
        etiqueta_telefono_2_pensionado.grid(
            row=5, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_telefono_2_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_telefono_2)
        campo_telefono_2_pensionado.grid(row=5, column=1, padx=5, pady=5)

        etiqueta_ciudad_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Ciudad: ')
        etiqueta_ciudad_pensionado.grid(
            row=7, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_ciudad_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_ciudad)
        campo_ciudad_pensionado.grid(row=7, column=1, padx=5, pady=5)

        etiqueta_colonia_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Colonia: ')
        etiqueta_colonia_pensionado.grid(
            row=8, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_colonia_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_colonia)
        campo_colonia_pensionado.grid(row=8, column=1, padx=5, pady=5)

        etiqueta_CP_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='CP: ')
        etiqueta_CP_pensionado.grid(
            row=9, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_CP_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_cp)
        campo_CP_pensionado.grid(row=9, column=1, padx=5, pady=5)

        etiqueta_numero_calle_pensionado = ttk.Label(
            seccion_datos_personales_pensionado, text='Numero de calle: ')
        etiqueta_numero_calle_pensionado.grid(
            row=10, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_numero_calle_pensionado = ttk.Entry(
            seccion_datos_personales_pensionado, textvariable=self.variable_numero_calle)
        ...
        seccion_datos_auto_pensionado = tk.LabelFrame(
            seccion_derecha, text="Datos del auto del pensionado")
        seccion_datos_auto_pensionado.grid(
            row=0, column=0, padx=5, pady=5, sticky=tk.NW)

        etiqueta_placa_auto_pensionado = ttk.Label(
            seccion_datos_auto_pensionado, text='Placa: ')
        etiqueta_placa_auto_pensionado.grid(
            row=0, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_placa_auto_pensionado = ttk.Entry(
            seccion_datos_auto_pensionado, textvariable=self.variable_placas)
        campo_placa_auto_pensionado.grid(row=0, column=1, padx=5, pady=5)

        etiqueta_modelo_auto_pensionado = ttk.Label(
            seccion_datos_auto_pensionado, text='Modelo: ')
        etiqueta_modelo_auto_pensionado.grid(
            row=1, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_placa_modelo_pensionado = ttk.Entry(
            seccion_datos_auto_pensionado, textvariable=self.variable_auto_modelo)
        campo_placa_modelo_pensionado.grid(row=1, column=1, padx=5, pady=5)

        etiqueta_color_auto_pensionado = ttk.Label(
            seccion_datos_auto_pensionado, text='Color: ')
        etiqueta_color_auto_pensionado.grid(
            row=2, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_color_auto_pensionado = ttk.Entry(
            seccion_datos_auto_pensionado, textvariable=self.variable_auto_color)
        campo_color_auto_pensionado.grid(row=2, column=1, padx=5, pady=5)

        seccion_datos_pension = tk.LabelFrame(
            seccion_derecha, text="Datos de la pension")
        seccion_datos_pension.grid(
            row=1, column=0, padx=5, pady=5, sticky=tk.NW)

        etiqueta_monto_dato_pension = ttk.Label(
            seccion_datos_pension, text='Monto X Mes: ')
        etiqueta_monto_dato_pension.grid(
            row=0, column=0, padx=5, pady=5, sticky=tk.NW)
        campo_monto_dato_pension = ttk.Entry(
            seccion_datos_pension, textvariable=self.variable_monto)
        campo_monto_dato_pension.grid(row=0, column=1, padx=5, pady=5)

        etiqueta_cortesia_dato_pension = ttk.Label(
            seccion_datos_pension, text='Cortesia: ')
        etiqueta_cortesia_dato_pension.grid(
            row=1, column=0, padx=5, pady=5, sticky=tk.NW)

        campo_cortesia_dato_pension = ttk.Combobox(
            seccion_datos_pension, width=5, state="readonly", textvariable=self.variable_cortesia)
        campo_cortesia_dato_pension["values"] = ["Si", "No"]

        campo_cortesia_dato_pension.grid(
            row=1, column=1, padx=1, pady=1, sticky=tk.NW)

        etiqueta_tolerancia = ttk.Label(
            seccion_datos_pension, text='Tolerancia: ')
        etiqueta_tolerancia.grid(row=2, column=0, padx=5, pady=5, sticky=tk.NW)
        self.campo_tolerancia = ttk.Entry(
            seccion_datos_pension, textvariable=self.variable_tolerancia)
        ...
        boton_modificar_pensionado = tk.Button(seccion_inferior, text='Desactivar tarjeta',
                                               command=self.desactivar_tarjeta, width=20, font=("Arial", 12), background="red")
        boton_modificar_pensionado.grid(row=0, column=0, padx=5, pady=5)

        # Crea un botón y lo empaqueta en la seccion_botones_consulta
        boton_modificar_pensionado = tk.Button(seccion_inferior, text='Guardar Cambios',
                                               command=self.modificar_pensionado, width=20, font=("Arial", 12), background="red")
    ...
    def desactivar_tarjeta(self):
        ...
        if vigencia == None:
            mb.showinfo(
                "Alerta", "La tarjeta ya esta desactivada, para reactivar la tarjeta es necesario realizar un pago de la pensión para asignar nueva fecha de vigencia")
            self.campo_tolerancia.focus()
            return

        respuesta = mb.askyesno(
            "Advertencia", "¿La desactivación es temporal?")
    ...
    def modificar_pensionado(self):
        ...
        try:
            ...
            datos_pensionado = (variable_numero_tarjeta, variable_nombre, variable_apellido_1, variable_apellido_2, variable_telefono_1, variable_telefono_2, variable_ciudad, variable_colonia, variable_cp,
                                variable_numero_calle, variable_placas, variable_auto_modelo, variable_auto_color, variable_monto, variable_cortesia, variable_tolerancia, fecha_modificación_pensionado, vigencia, estatus)
